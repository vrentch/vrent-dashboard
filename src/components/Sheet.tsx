  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
      <div
        ...
        aria-hidden
      />
      <div className="relative w-full sm:max-w-lg md:max-w-xl max-h-[88vh] flex flex-col rounded-t-3xl sm:rounded-3xl glass-strong shadow-2xl animate-in">
        <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-slate-100 dark:border-slate-800">
          ...
          <button
            onClick={onClose}
            className="absolute right-4 top-4 grid place-items-center w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 active:scale-95"
            aria-label="Close"
          >
            <X size={18} />
          </button>
